...
def init_database():
    ...
    # Initialize announcements if empty - add an example announcement
    if announcements_collection.count_documents({}) == 0:
        example = {
            ...
            # optional start date left off (None) to make it active immediately
            "start_date": None,
            # expiry in 30 days by default
